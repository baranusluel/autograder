...
public class diff_match_patch {
  ...
  public static LinkedList<Diff> diff(String str1, String str2) {
    diff_match_patch dmp = new diff_match_patch();
    LinesToCharsResult res = dmp.diff_linesToChars(str1, str2);
    String txt1 = res.chars1;
    String txt2 = res.chars2;
    List<String> conv = res.lineArray;
    LinkedList<Diff> diff = dmp.diff_main(txt1, txt2, false);
    dmp.diff_charsToLines(diff, conv);
