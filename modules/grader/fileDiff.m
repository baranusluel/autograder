...
if nargin == 2
    ...
    left = {'<div class="col-sm-6 file-diff-left">', '<p><strong>', sanitize(fName1), '</strong></p>', '<div class="diff-content">', ''};
    right = {'<div class="col-sm-6 file-diff-right">', '<p><strong>', sanitize(fName2), '</strong></p>', '<div class="diff-content">', ''};
