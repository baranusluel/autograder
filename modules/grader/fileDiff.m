...
BOILER = [{'<!DOCTYPE html>', '<html>', '<head>', '<style>', ...
    'span {font-family: "Courier New"} .diff-equal {background-color: white;} .diff-delete {background-color: lightgreen;} .diff-insert {background-color: darkred; color: white; text-decoration: line-through;} .diff-invisible {color: white}', ...
