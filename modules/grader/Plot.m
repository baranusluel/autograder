...
classdef Plot < handle
    ...
    methods (Access=public)
        ...
        elseif any(this.PlotBox < (that.PlotBox - Plot.POSITION_MARGIN)) ...
                    || any(this.PlotBox > (that.PlotBox + Plot.POSITION_MARGIN))
            msg = sprintf(['Your plot has a Plot Box of [%0.2f, %0.2f, %0.2f, %0.2f], ', ...
                'but we expected [%0.2f, %0.2f, %0.2f, %0.2f] (Did you call subplot correctly?)'], ...
                this.PlotBox(1), this.PlotBox(2), this.PlotBox(3), this.PlotBox(4), ...
                that.PlotBox(1), that.PlotBox(2), that.PlotBox(3), that.PlotBox(4));
        elseif ~isequal(this.Limits(1:4), that.Limits(1:4))
            msg = sprintf(['Your plot has Limits of [%0.2f, %0.2f, %0.2f, %0.2f], ', ...
                ...
                this.Limts(1), this.Limits(2), this.Limits(3), this.Limits(4), ...
        ...
        html = sprintf(['<div class="row"><div class="col-md-6 text-center">', ...
            ...
            '<img class="img-fluid img-thumbnail" src="%s"></div><p class="text-center student-error">%s</p></div>'],...
