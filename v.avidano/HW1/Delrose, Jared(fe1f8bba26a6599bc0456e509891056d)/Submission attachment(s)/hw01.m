%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name         : <Jared Delrose>
% T-square ID  : <jdelrose3>
% GT Email     : <jdelrose3@gmail.com>
% Homework     : <homework assignment number 01 original>
% Course       : CS1371
% Section      : <D03>
% Collaboration:
...
%
% Test Cases:
 [out1] = cartDist_soln(4, 5, 7, 9)
% 	out1 => 5
% 
 [out1] = cartDist_soln(4, 3, -7, -10)
% 	out1 => 17.03
% 
 [out1] = cartDist_soln(0, 0, 0, 0)
% 	out1 => 0
%
%--------------------------------------------------------------------------------
