%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name         : <KOUETEY DAVID NICOUE>
% T-square ID  : <knicoue3>
% GT Email     : <nicoueda@gatech.edu>
% Homework     : <homework assignment number one /original>
% Course       : CS1371
% Section      : <D03>
% Collaboration: <place here one of the following:
%                 "I worked on the homework assignment alone, using
%                  only course materials and by looking ."
%                 
%                 
%
% Files to submit:
