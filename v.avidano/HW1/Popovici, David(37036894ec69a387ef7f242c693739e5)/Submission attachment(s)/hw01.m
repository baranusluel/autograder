...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name         : David Popovici
% T-square ID  : Dpopovici3
% GT Email     : davidpopovici@gatech.edu
% Homework     : 1
% Course       : CS1371
% Section      : C02
% Collaboration: "I worked on this homework with <DNA>, used solutions or partial
%                  solutions provided by <DNA>, and referred to
%                  mathworks.com"
%
% Files to submit:
%	ABCs_functions.m
...
%(due to encapsulation) function scope
%helper functions
