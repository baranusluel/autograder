%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name         : <Harrison Hornung>
% T-square ID  : <hhornung3>
% GT Email     : <hhornung3@gatech.edu>
% Homework     : <HW1/Original>
% Course       : CS1371
% Section      : <B03>
% Collaboration: <"I worked on this homework with Caroline Rogers>
%
% Files to submit:
%	ABCs_functions.m
