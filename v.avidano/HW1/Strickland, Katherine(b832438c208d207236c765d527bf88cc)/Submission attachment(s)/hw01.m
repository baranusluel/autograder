%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name         : <Katherine Strickland>
% T-square ID  : <kstrickland35>
% GT Email     : <kstrickland35@gatech.edu>
% Homework     : <hm01>
% Course       : CS1371
% Section      : <B01>
% Collaboration: <I worked on this homework with <Mitch McIntire, Noble Harris, Parker Dowe>, 
%                  used solutions or partial solutions provided by <recitation materials, 
%                   recitation TAs, in-class lecture>, and referred to <recitation materials.>
%
% Files to submit:
%	ABCs_functions.m
