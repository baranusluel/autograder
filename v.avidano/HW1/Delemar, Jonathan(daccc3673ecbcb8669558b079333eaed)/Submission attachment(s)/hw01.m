%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name         : Jonathan Delemar
% T-square ID  : jdelemar7
% GT Email     : jpdelemar@gatech.edu
% Homework     : <homework assignment number/original or resubmission>
% Course       : CS1371
% Section      : D01
% Collaboration: I worked with Pampam Akinyemi on this assignment and she 
%                gave me clarity on some things I wasn't sure of. 
%             
%
% Files to submit:
%	ABCs_functions.m
